 ...
 */
abstract class ConcurrentRefHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, ObjectHashingStrategy<K> {
  ...
  @NotNull
  abstract KeyReference<K, V> createKeyReference(@NotNull K key, @NotNull V value, @NotNull ObjectHashingStrategy<K> hashingStrategy);
  ...
  private static final ObjectHashingStrategy THIS = new ObjectHashingStrategy() {
    @Override
  ...
  ConcurrentRefHashMap(@NotNull final ObjectHashingStrategy<K> hashingStrategy) {
  ...
  ConcurrentRefHashMap(int initialCapacity,
                              ...
                              @NotNull ObjectHashingStrategy<K> hashingStrategy) {
